...
public class LogUtil {
    private final static boolean isDebugg=true;
    ...
    public static void showErroLog(String messge){
        if(isDebugg){
            ...
            if(stacks.length>0&&stacks[1]!=null) {
                Log.e(stacks[1].getClassName().toString(), stacks[1].getMethodName() + "cmo --->"+"##  " + messge+"  ##");
            }else{
                Log.e("cmo","**"+messge+"##");
            }
        }
    ...
    public static void showModelLog(String messge){
        if(isDebugg){
            ...
            StackTraceElement[] stacks = new Throwable().getStackTrace();
            if(stacks.length>0&&stacks[1]!=null) {
                Log.e(stacks[1].getClassName().toString(), stacks[1].getMethodName() + "faceapi -->"+"**  " + messge+"  **");
            }else{
                Log.e("cmo -->","**  "+messge+" ##");
            }
        }
